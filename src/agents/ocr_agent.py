...
Contract (IMPLEMENTATION_PLAN.md §2.3): output = extracted text string, ""
if none found (never None — downstream code should not have to null-check
this; it also satisfies the Elasticsearch schema's asr_text/ocr_text typing
directly).
